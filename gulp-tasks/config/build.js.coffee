module.exports = (gulp, plugins, growl, path) ->
  ...
  gulp.task 'build:watch', () ->
    ...
    gulp.watch(['src/admin-dashboard/javascripts/**/*'], ['build:admin-booking:javascripts'])
    gulp.watch(['src/admin-dashboard/stylesheets/**/*'], ['build:admin-booking:stylesheets'])
    gulp.watch(['src/admin-dashboard/images/**/*'], ['build:admin-booking:images'])
    gulp.watch(['src/admin-dashboard/templates/**/*'], ['build:admin-booking:templates'])
