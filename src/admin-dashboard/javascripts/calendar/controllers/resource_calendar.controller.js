    ...
    .controller('bbResourceCalendarController', function (AdminBookingPopup, AdminCalendarOptions, AdminCompanyService,
        ...
        let prepareUiCalOptions = function () {
            vm.uiCalOptions = { // @todo REPLACE ALL THIS WITH VARIABLES FROM THE GeneralOptions Service
                calendar: {
                    ...
                    timezone: bbTimeZone.displayTimeZone
                }
            };
        ...
        let fcEventDrop = function (booking, delta, revertFunc) { // we need a full move cal if either it has a person and resource, or they've dragged over multiple days
            ...
            if (GeneralOptions.custom_time_zone) {
                ...
                booking.start = calendar.moment(moment.tz(booking.start.toISOString(), bbTimeZone.displayTimeZone));
                booking.end = calendar.moment(moment.tz(booking.end.toISOString(), bbTimeZone.displayTimeZone));
            }
