angular.module('BBAdmin.Services').factory('AdminScheduleService', function ($q, BBModel, ScheduleRules, BBAssets, bbi18nOptions, GeneralOptions, CompanyStoreService) {
