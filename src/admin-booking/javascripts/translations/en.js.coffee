  ...
  translations = {
    ADMIN_BOOKING: {
      CALENDAR: {
        ...
        BACK                              : '@:CORE.COMMON.BTN.BACK'
        BOOK                              : '@:CORE.COMMON.BTN.BOOK'
        SELECT                            : '@:CORE.COMMON.BTN.SELECT'
        CALENDAR                          : '@:CORE.COMMON.TERMINOLOGY.CALENDAR'
        ...
        AFTERNOON                         : '@:CORE.COMMON.TERMINOLOGY.AFTERNOON'
        EVENING                           : '@:CORE.COMMON.TERMINOLOGY.EVENING'
        MORNING                           : '@:CORE.COMMON.TERMINOLOGY.MORNING'
      }
      CUSTOMER    : {
        BACK_BTN          : '@:CORE.COMMON.BTN.BACK'
        CLEAR             : '@:CORE.COMMON.BTN.CLEAR'
        CREATE            : 'Create Customer'
        CREATE_BTN        : 'Create Customer'
        CREATE_ONE_INSTEAD: 'Create one instead'
        EMAIL             : '@:CORE.COMMON.FORM.EMAIL'
        FIRST_NAME        : '@:CORE.COMMON.FORM.FIRST_NAME'
        LAST_NAME         : '@:CORE.COMMON.FORM.LAST_NAME'
        MOBILE            : '@:CORE.COMMON.FORM.MOBILE:'
        ...
        SORT_BY           : 'Sort by'
        SORT_BY_EMAIL     : '@:CORE.COMMON.FORM.EMAIL'
        SORT_BY_FIRST_NAME: '@:CORE.COMMON.FORM.FIRST_NAME'
        SORT_BY_LAST_NAME : '@:CORE.COMMON.FORM.LAST_NAME'
        ADDRESS1_LABEL    : '@:CORE.COMMON.FORM.ADDRESS1'
        ADDRESS1_VALIDATION_MSG : 'Please enter an address'
        ADDRESS3_LABEL    : '@:CORE.COMMON.FORM.ADDRESS3'
        ADDRESS4_LABEL    : '@:CORE.COMMON.FORM.ADDRESS4'
        POSTCODE_LABEL    : '@:CORE.COMMON.FORM.POSTCODE'
      ...
      QUICK_PICK  : {
        ...
        BOOK                           : '@:CORE.COMMON.BTN.BOOK'
        NEXT                           : '@:CORE.COMMON.BTN.CONTINUE'
        FOR                            : 'For'
        FROM                           : 'From'
        MAKE_BOOKING                   : 'Make booking'
        NO                             : '@:CORE.COMMON.BTN.NO'
        SELECT                         : '-- select --'
        SELECT_A_SERVICE               : '-- select a service --'
        SERVICE                        : '@:CORE.COMMON.TERMINOLOGY.SERVICE'
        TO                             : 'To'
        YES                            : '@:CORE.COMMON.BTN.YES'
        FIELD_VALIDATION_MSG           : '@:CORE.COMMON.FORM.FIELD_REQUIRED'
      ...
      BOOKINGS_TABLE : {
        ...
        DETAILS_BTN : '@:CORE.COMMON.BTN.DETAILS'
      }
      CHECK_ITEMS : {
        BOOKINGS_QUESTIONS_TITLE : '@:CORE.COMMON.TERMINOLOGY.QUESTIONS'
        FIELD_VALIDATION_MSG     : '@:CORE.COMMON.FORM.FIELD_REQUIRED'
        BOOKING_NOTES_TITLE      : 'Booking Notes'
        BOOK_BTN                 : '@:CORE.COMMON.BTN.BOOK'
        BACK_BTN                 : '@:CORE.COMMON.BTN.BACK'
