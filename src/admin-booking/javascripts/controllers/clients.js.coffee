...
angular.module('BBAdminBooking').controller 'adminBookingClients', ($scope, $rootScope, $q, AlertService,
  ...
  console.warn('Deprecation warning: validator.validateForm() will be removed from bbAdminBookingClients in an upcoming major release, please update your template to use bbForm and submitForm() instead. See https://github.com/bookingbug/bookingbug-angular/issues/1')
