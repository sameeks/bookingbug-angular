...
angular.module('BBAdminBooking').controller('adminBookingClients', function($scope, $rootScope, $q, AlertService, ValidatorService, ErrorService, $log, BBModel, $timeout, LoadingService, AdminBookingOptions, $translate) {
  ...
  $scope.createClient = route => {
    ...
    if ($scope.client_details) { $scope.client.setClientDetails($scope.client_details); }
  ...
  $scope.getClients = function(params, options) {
    ...
    if (!params || (params && !params.filter_by)) { return; }
    ...
    if (AdminBookingOptions.use_default_company_id) { $scope.params.default_company_id = $scope.bb.company.id; }
  ...
  $scope.searchClients = function(search_text) {
    ...
    if (AdminBookingOptions.use_default_company_id) { params.default_company_id = $scope.bb.company.id; }
