  ...
  translations = {
    PUBLIC_BOOKING: {
      ...
      EVENT: {
        ...
        TICKET_WORD: "Ticket"
        DETAILS_WORD: "details"
        RESERVE_TICKET: "Reserve {num_tickets, plural, =0{Ticket} one{Ticket} other{Tickets}}"
        EVENT_JOIN_WAITLIST: "Join Waitlist" 
        BOOK_TICKET: "Book {num_tickets, plural, =0{Ticket} one{Ticket} other{Tickets}}"
        BACK_BTN: "@:COMMON.BTN.BACK"
      }
      EVENT_GROUP_LIST: {
        PROGRESS_SELECT: "@:COMMON.BTN.SELECT"
      ...
      EVENT_LIST: {
        ...
        SHOW_FULLED_BOOKED_EVENTS: "Show Fully Booked Events"
        FILTER_RESET: "@:COMMON.TERMINOLOGY.RESET" 
