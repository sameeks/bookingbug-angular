...
angular.module('BB.Services').config ($translateProvider) ->
  ...
  translations = {
    PUBLIC_BOOKING: {
      ...
      ADD_RECIPIENT: {
        MODAL_TITLE: "@:CORE.COMMON.TERMINOLOGY.RECEIPIENT"
      ...
      MEMBER_LOGIN_FORM: {
        EMAIL_LABEL: "@:CORE.COMMON.FORM.EMAIL"
        EMAIL_VALIDATION_REQUIRED_MESSAGE: "@:CORE.COMMON.FORM.EMAIL_REQURIED"
      ...
      BASKET: {
        ...
        ITEM: "@:CORE.COMMON.TERMINOLOGY.ITEM"
        ITEM_PRICE: "@:CORE.COMMON.TERMINOLOGY.PRICE"
        BASKET_RECIPIENT: "@:CORE.COMMON.TERMINOLOGY.RECEIPIENT"
      ...
      DASH: {
        DASHBOARD: "Dashboard"
        DASHBOARD_TITLE: "Pick a Location/@:CORE.COMMON.TERMINOLOGY.SERVICE"
      }
      DAY: {
      ...
      DEAL_LIST: {
        ...
        RECIPIENT_EMAIL_VALIDATION_MSG: "@:CORE.COMMON.FORM.EMAIL_REQURIED"
        RECIPIENT: "@:CORE.COMMON.TERMINOLOGY.RECEIPIENT"
        RECIPIENT_NAME: "Name"
        PROGRESS_BUY: "Buy"
        PROGRESS_BACK: "@:CORE.COMMON.BTN.BACK"
      ...
      TIME: {
        ...
        AVAIL_NO: "No @:CORE.COMMON.TERMINOLOGY.SERVICE Available"
        PROGRESS_BACK: "@:CORE.COMMON.BTN.BACK"
