;window.bookingbug.translations.fr = {
  ...
  "AVAIL_NO":"Pas de service disponible",
  ...
  "EVENT_PAYMENT":"S'il vous plaît effectuer le paiement pour confirmer votre réservation",
  "WAITLIST_BOOKING_TITLE":"Votre réservation est sur la liste d'attente",
  "BASKET_TITLE":"Votre Panier",
  "BASKET_WALLET":"portefeuille",
  "BASKET_WALLET_MAKE_PAYMENT":"effectuer le paiement",
  "BASKET_WALLET_BALANCE_INSUFFICIENT":"Oh non! Vous ne possédez pas actuellement assez d'argent dans votre compte de portefeuille. Vous pouvez soit payer le montant intégral, ou en haut pour ajouter plus d'argent à votre portefeuille.",
  "BASKET_WALLET_REMAINDER_PART_ONE":"Vous aurez", 
  "BASKET_WALLET_REMAINDER_PART_TWO":"laissé dans votre portefeuille après cet achat",
  "BASKET_WALLET_TOP_UP":"Top Up",
  "BASKET_WALLET_AMOUNT":"Montant",
  "BASKET_WALLET_AMOUNT_MINIMUM":"Montant de recharge minimum doit être supérieur",
  ...
  "CLIENT_DETAILS_FIRST_NAME":"Saisissez le prénom du client",
  "CLIENT_DETAILS_FIRST_NAME":"S'il vous plaît entrez le prénom du client",
  "CLIENT_DETAILS_LAST_NAME":"Saisissez le nom du client",
  ...
  "WALLET_NO_CREDIT": "Vous n'avez pas de crédit.",
  "WALLET_NOT_ACTIVE": "Votre wallet n'est pas actif.",
  "ACTIVATE": "Activer",
  "ACTIVE": "Actif",
  "STATUS": "Statut",
  "TOP_UP": "Recharger",
