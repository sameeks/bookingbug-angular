...
* @property {array} questions Questions array
...
angular.module('BB.Controllers').controller 'SurveyQuestions', ($scope,  $rootScope,
  ...
  * @methodOf BB.Directives:bbSurveyQuestions
  * @description
  * Load Survey according to purchase parameter.
  *
  ...
  * @methodOf BB.Directives:bbSurveyQuestions
  * @description
  * Submit survey login according to form parameter else display an error message.
  *
  * @param {object} form Survey login form
  ###
  ...
  * @methodOf BB.Directives:bbSurveyQuestions
  * @description
  * Submit survey according to form parameter.
  *
  * @param {object} form Survey form
  ###
  ...
  * @methodOf BB.Directives:bbSurveyQuestions
  * @description
  * Submit booking according to form parameter.
  *
  * @param {object} form Submit booking form
  ###
