  ...
  return {
    ...
    */
    ...
    getMailingPattern() {
      ...
      switch (cc) {
        case "us": return us_postcode_regex;
        case "gb": return uk_postcode_regex_lenient;
        default: return null; 
      }
    },
    ...
    */
    getUKMobilePattern(strict) {
      ...
      if (strict) { return uk_mobile_regex_strict; }
    ...
    */
    getUKLandlinePattern(strict) {
      if (strict == null) { strict = false; }
      if (strict) { return uk_landline_regex_strict; }
    ...
    */
    getGeocodeResult() {
      if (geocode_result) { return geocode_result; }
    },
    ...
    */
    validatePostcode(form, prms) {
      ...
      if (!form || !form.postcode) { return false; }
