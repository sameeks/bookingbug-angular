...
angular.module('BB.Models').factory "BBWidget", ($q, BBModel, BasketService, $urlMatcherFactory, $location, BreadcrumbService, $window, $rootScope, PathHelper, GeneralOptions, $translate) ->
    ...
    * @returns {string} The returned record step
    ...
    recordCurrentPage: () =>
      ...
      setDocumentTitle = (title) ->
        document.title = $translate.instant(title) if GeneralOptions.update_document_title and title
