...
angular.module('BB.Controllers').controller('Checkout', function($scope, $rootScope,
  ...
  $scope.checkout = function() {
    ...
    if ($scope.options.no_notifications) { $scope.bb.no_notifications = $scope.options.no_notifications; }
  ...
  */
  ...
  return $scope.printElement = function(id, stylesheet) {
    ...
    return $timeout(function() {
      ...
      if (stylesheet) { mywindow.document.write(`<link rel="stylesheet" href="${stylesheet}" type="text/css" />`); }
