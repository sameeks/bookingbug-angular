  ...
  class Client extends BaseModel {
    ...
    */
    setTimeZone(time_zone) {
      if (time_zone != null) { this.time_zone = time_zone; } 
    }
    ...
    */
    setDefaults(values) {
      ...
      if (values.first_name) { this.first_name = values.first_name; }
      if (values.last_name) { this.last_name = values.last_name; }
      if (values.phone) { this.phone = values.phone; }
      if (values.mobile) { this.mobile = values.mobile; }
      if (values.email) { this.email = values.email; }
      if (values.id) { this.id = values.id; }
      if (values.ref) { this.comp_ref = values.ref; }
      if (values.comp_ref) { this.comp_ref = values.comp_ref; }
      if (values.address1) { this.address1 = values.address1; }
      if (values.address2) { this.address2 = values.address2; }
      if (values.address3) { this.address3 = values.address3; }
      if (values.address4) { this.address4 = values.address4; }
      if (values.address5) { this.address5 = values.address5; }
      if (values.postcode) { this.postcode = values.postcode; }
      if (values.country) { this.country = values.country; }
      if (values.answers) { this.default_answers = values.answers; }
      if (values.time_zone) { return this.time_zone = values.time_zone; }
    }
    ...
    */
    pre_fill_answers(details) {
      if (!this.default_answers) { return; }
      return (() => {
        let result = [];
    ...
    */
    getName() {
      let str = "";
      if (this.first_name) { str += this.first_name; }
      if ((str.length > 0) && this.last_name) { str += " "; }
    ...
    */
    getPostData() {
      ...
      if (this.member_level_id) { x.member_level_id = this.member_level_id; }
      if (this.send_welcome_email) { x.send_welcome_email = this.send_welcome_email; }
      if (this.default_company_id) { x.default_company_id = this.default_company_id; }
      if (this.time_zone) { x.time_zone = this.time_zone; }

      if (this.phone) {
        x.phone = this.phone;
        if (this.phone_prefix) { x.phone_prefix = this.phone_prefix; }
      }
    ...
    */
    fullMobile() {
      ...
      if (!this.mobile_prefix) { return this.mobile; }
