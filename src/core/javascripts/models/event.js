                    ...
                    return this.chain.getTickets().then(tickets => {
                            ...
                            if (tickets && (tickets.length > 0)) {
                                for (let ticket of Array.from(this.tickets)) {
                                    if (!this.price_range.from || (this.price_range.from && (ticket.price < this.price_range.from))) {
                                        this.price_range.from = ticket.price;
                                    }
                                    if (!this.price_range.to || (this.price_range.to && (ticket.price > this.price_range.to))) {
                                        this.price_range.to = ticket.price;
                                    }
