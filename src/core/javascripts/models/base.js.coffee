...
angular.module('BB.Models').service "BBModel", ($q, $injector) ->
  ...
  models = ['Address', 'Answer', 'Affiliate', 'Basket', 'BasketItem',
    ...
    'PrePaidBooking', 'MembershipLevel', 'Product', 'BaseCollection', 'ExternalPurchase', 'PackageItem', 'BulkPurchase', 'Pagination', 'Reason', 'EventCollection', 'EventChainCollection']
  ...
  # member models
  member_models = ['Member', 'Booking', 'PrePaidBooking', 'Wallet', 'WalletLog', 'Purchase', 'PurchaseItem', 'WalletPurchaseBand', 'BookingCollection']
  mfuncs = {}
